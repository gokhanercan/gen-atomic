...
st.sidebar.markdown(
    "<h1 style='border1:1px solid red; margin-top:-50px;'>Resources</h1>",
...
selPrompting: PromptingInfo = bar.selectbox(
    "Prompting Methods",
    promptings,
...
selectedDecorators: list[PromptDecoratorInfo] = bar.multiselect(
    "Prompt Decorators",
    decoratorsInfos,
    format_func=lambda d: d.plain_name,
    help="Select decorators to apply on the prompt. These will be applied in the order they are selected.",
)
