...
class HiddenZeroShotCoTDecorator(PromptDecoratorBase):
    ...
    _HIDDEN_COT_PROMPT_AS_PREFIX: Prompt = Prompt(
        "Think step by step and show your reasoning before outputting the final [LANG_DESC] code inside triple backticks."
    )
