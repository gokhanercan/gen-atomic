...
#
#
# class ModelProviderFactory(object):
#
#     def __init__(self) -> None:
#         super().__init__()
#
#     @staticmethod
#     def GetAllProviderNames()->List[str]:
#         """
...
#     print(factory.GetAllProviderNames())
#     print(factory.CreateModelConfigurations(factory.GetAllProviderNames()[0]))