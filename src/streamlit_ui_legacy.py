...
st.sidebar.markdown(
    "<h1 style='border1:1px solid red; margin-top:-50px;'><u>gen-atomic</u></h1>",
...
if projectRoot.startswith("/mount"):
    dsPath = "/mount/src/gen-atomic/data/AtomicRegexValDataset.xml"  # TODO: Temp
...
if "generatedCode" not in st.session_state:
    st.session_state.generatedCode = ""
